...
All the accuracies from the predictions of the hold-out samples at each Fold of the cross-validation process, are averaged and give us in the end the overall Accuracy. This is an estimate of the out-of-sample error rate.
...
```{r eval=TRUE, message=FALSE, warning=FALSE, out.width='400px', fig.align='center'}
...
```{r eval=TRUE, message=FALSE, warning=FALSE, out.width='500px', fig.align='center'}
plot(model_1)
```

**Figure 4: RF model Variable importance (with preprocessing).**

```{r eval=TRUE, message=FALSE, warning=FALSE, out.width='600px', fig.align='center'}
plot(varImp(model_1))
```
